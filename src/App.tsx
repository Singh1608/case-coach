...
const MODEL_ORDER: Record<string, string[]> = {
  Hard:   ["gemini-2.5-flash", "gemini-2.0-flash-lite", "gemini-2.0-flash-001", "gemini-2.0-flash-lite"],
  Medium: ["gemini-2.0-flash-lite", "gemini-2.5-flash", "gemini-2.0-flash-001", "gemini-2.0-flash-lite"],
  Easy:   ["gemini-2.0-flash-lite", "gemini-2.5-flash", "gemini-2.0-flash-001", "gemini-2.0-flash-lite"],
};
